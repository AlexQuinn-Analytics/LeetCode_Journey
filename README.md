# My LeetCode Journey: Road to SDE 🚀
...
I categorize my "weaknesses" into a **Logic Ledger** (弱题本). For every complex problem, I follow a 3-step execution model:
...
- **Key Implementation**: [Sum of Two Integers](./src/bit/SumOfTwoIntegers.java) - *Mastering Carry Propagation via `(a & b) << 1`.*

### 🟡 Linked Lists
Handling memory pointer manipulation and edge-case management (Dummy Nodes, Fast/Slow Pointers).
- **Key Implementation**: [Reorder List](./src/linkedlist/ReorderList.java) - *Implementing $O(1)$ space complexity by combining middle-finding, reversing, and merging.*
...
---
*“Prudent, evidence-based research into every line of code.”*
